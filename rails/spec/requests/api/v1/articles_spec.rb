# rails/spec/requests/api/v1/articles_spec.rb
...
RSpec.describe "Api::V1::Articles", type: :request do
  describe "GET api/v1/articles" do
    ...
    before do
      # create_list は、 同じテーブルのレコードを複数作成できるメソッド
  ...
  describe "GET api/v1/articles/:id" do
    ...
    context "article_id に対応する articles レコードが存在する時" do
      ...
      context "articles レコードのステータスが下書きの時" do
        # * rails/spec/factories/articles.rb でつくられた articleの statusの
        # * 値を、下記の :draft で上書きしている
        let(:status) { :draft }
